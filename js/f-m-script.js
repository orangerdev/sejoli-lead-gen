    ...
    if (jQuery('.lfb-cd-btn').length) {
        ...
        jQuery("#lfb-header-algmnt-tb").slider({
            ...
            create: function() {
                ...
                jQuery('.lead-head').css({
                    "padding-top": valueRangeTB + '%',
                    'padding-bottom': valueRangeTB + '%'
                });
        ...
        jQuery("#lfb-header-algmnt-lr").slider({
            ...
            create: function() {
                ...
                jQuery('.lead-head').css({
                    "padding-left": valueRangeLR + '%',
                    'padding-right': valueRangeLR + '%'
                });
        ...
        jQuery("#lfb-form-padding-top").slider({
            ...
            slide: function(event, ui) {
                ...
                jQuery('.leadform-show-form .lead-form-front').css({
                    "padding-top": ui.value + '%'
                });
        ...
        function saveButtonActive() {
            jQuery("#saveColor, .saveColor").css({
                "background": '#000'
            });
        ...
        function lfbColorChanger(cssValue) {
            ...
            jQuery(".leadform-show-form input[type='submit']").css({
                ...
                "background-color": $lfb_color_button_bg,
...
jQuery("form#lfb-form-success-msg").submit(function(event) {
    ...
    form_data = form_data + "&action=SaveThankyouSettings";
    event.preventDefault();
    jQuery("#error-thankyou-message-setting").find("div").remove();
    SaveByAjaxRequest(form_data, 'POST').success(function(response) {
        //alert(response);
        console.log(response);
        if (jQuery.trim(response) == 'updated' || jQuery.trim(response) == '') {
            jQuery("#error-thankyou-message-setting").append("<div class='success'><p>Updated Succesfully..!!</p></div>");
        } else {
            jQuery("#error-thankyou-message-setting").append("<div class='error'><p>Something Went Wrong..!!</p></div>");
        }
    });
})
/*
