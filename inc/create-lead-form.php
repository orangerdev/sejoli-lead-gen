...
Class LFB_AddNewForm {
    ...
    function lfb_add_form_setting() {
        ...
        <div id='titlewrap'>
        <input type='text' class='new_form_heading' name='form_page_url' placeholder='".esc_html__('Enter form page url here','lead-form-builder')."' value='' size='30' id='title' spellcheck='true' autocomplete='off'></div><!-- #titlewrap -->
        </br>
        ...
        <p class='submit'><input type='submit' class='save_form button-primary' name='save_form' id='save_form' value='".esc_html__('Save Form','lead-form-builder')."'></p></td>
